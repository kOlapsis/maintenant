  ...
  <div class="flex flex-col h-full">
    ...
    <template v-else-if="detail">
      ...
      <div class="px-5 pt-4 pb-3 border-b border-slate-800">
        <div class="min-w-0">
          ...
          <div class="flex items-center gap-2 mt-1 flex-wrap">
            ...
            <span v-if="detail.pod.status_reason" class="text-[10px] text-slate-400">
        ...
        <div class="mt-3 grid grid-cols-2 gap-x-6 gap-y-2 text-xs">
          ...
          <div>
            ...
            <p
              :class="detail.pod.restart_count > 0 ? 'text-amber-400' : 'text-pb-secondary'"
      ...
      <div class="flex border-b border-slate-800 px-5">
        ...
        >
          {{ tab.label }}
          <span v-if="tab.key === 'containers'" class="ml-1 text-[10px] text-slate-600">{{
        ...
        <template v-if="activeTab === 'containers'">
          ...
          <div v-else class="space-y-2">
            ...
            >
              ...
              <div class="mt-1.5 text-xs text-slate-500 font-mono truncate">
                {{ container.image }}
              </div>
              <div class="flex items-center gap-4 mt-1 text-xs text-slate-600">
                <span v-if="container.state_reason" class="text-amber-400">{{
                  container.state_reason
                }}</span>
                <span v-if="container.restart_count > 0" class="text-amber-400"
