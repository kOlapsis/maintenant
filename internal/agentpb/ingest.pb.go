...
const file_proto_ingest_proto_rawDesc = "" +
	...
	"\x15max_events_per_second\x18\x03 \x01(\rR\x12maxEventsPerSecond\"\x86\x02\n" +
	"\rClientMessage\x127\n" +
	...
	"\x06result\x18\x03 \x01(\v2\".maintenant.agent.v1.CommandResultH\x00R\x06result\x12:\n" +
	"\x06status\x18\x04 \x01(\v2 .maintenant.agent.v1.SpoolStatusH\x00R\x06statusB\t\n" +
	"\apayload\"\x8a\x02\n" +
	"\rServerMessage\x12B\n" +
	...
	"observedAt\x12\x10\n" +
	"\x03seq\x18\x04 \x01(\x04R\x03seq\x12\x1a\n" +
	"\breplayed\x18\x05 \x01(\bR\breplayed\x12C\n" +
	"\tcontainer\x18\n" +
...
func file_proto_ingest_proto_init() {
	...
	file_proto_ingest_proto_msgTypes[15].OneofWrappers = []any{
